...
class RegistrationForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "specify_sector": forms.TextInput(attrs={"class": "form-control", "placeholder": "If other, please specify"}),

            "leadership_position": forms.Select(attrs={"class": "form-select"}),
            "specify_other": forms.TextInput(attrs={"class": "form-control"}),

            "participation_source": forms.Select(attrs={"class": "form-select"}),
            "specify_source": forms.TextInput(attrs={"class": "form-control"}),

            "reason_for_attending": forms.CheckboxSelectMultiple(),
            "specify_reason": forms.TextInput(attrs={"class": "form-control"}),
            ...
            "specify_volunteer": forms.TextInput(attrs={"class": "form-control"}),
            "accessibility_accommodations": forms.CheckboxSelectMultiple(),
            "specify_accessiblity": forms.TextInput(attrs={"class": "form-control"}),
